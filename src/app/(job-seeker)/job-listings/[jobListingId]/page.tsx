...
} from '@/features/jobListingApplications/db/cache/jobListingApplications';
  ...
  if (application != null) {
    ...
    return (
      <div className="text-muted-foreground text-sm">
        You applied for this job {difference === 0 ? 'today' : formatter
