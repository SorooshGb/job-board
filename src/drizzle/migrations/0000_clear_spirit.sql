...
CREATE TYPE "public"."job_listings_location_requirements" AS ENUM('in-office', 'hybrid', 'remote');--> statement-breakpoint
CREATE TYPE "public"."job_listings_wage_interval" AS ENUM('hourly', 'yearly');--> statement-breakpoint
CREATE TYPE "public"."job_listing_application_stage" AS ENUM('denied', 'applied', 'interested', 'interviewed', 'hybrid');--> statement-breakpoint
CREATE TABLE "users" (
...
CREATE TABLE "job_listings" (
	...
	"locationRequirement" "job_listings_location_requirements" NOT NULL,
