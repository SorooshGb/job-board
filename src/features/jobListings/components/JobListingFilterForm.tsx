...
export default function JobListingFilterForm() {
  ...
  const form = useForm({
    ...
    defaultValues: {
      ...
      locationRequirement: searchParams
        .get('locationRequirement') as LocationRequirement ?? ANY_VALUE,
      stateAbbreviation: searchParams
        .get('state') ?? ANY_VALUE,
      experienceLevel: searchParams.get('experience') as ExperienceLevel
        ?? ANY_VALUE,
