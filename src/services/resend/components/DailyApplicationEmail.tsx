    ...
    <Tailwind config={tailwindConfig}>
      <Html>
        ...
        <Container className="font-sans">
          ...
          <Text>
            Hi{' '}
            {userName}. Here are all the new applications for your job listings.
          </Text>
          {Object
            .entries(Object.groupBy(applications, a => a.organizationId))
...
function JobListingCard({ applications, jobListingTitle, noMargin }: {
  jobListingTitle: string;
  applications: Application[];
  noMargin?: boolean;
}) {
